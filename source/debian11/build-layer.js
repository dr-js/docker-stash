...
runKit(async (kit) => {
  ...
  kit.padLog('assemble "build-layer-resource/"')
  {
    ...
    // update at 2021/12/20, to find download from: https://www.jruby.org/download or https://github.com/jruby/jruby/releases/
    const TGZ_JRUBY = [ 'https://repo1.maven.org/maven2/org/jruby/jruby-dist/9.3.2.0/jruby-dist-9.3.2.0-bin.tar.gz', '26699ca02beeafa8326573c1125c57a5971ba8b94d15f84e6b3baf2594244f33' ]
    ...
    for (const [ text, file ] of [
      ...
      // update at 2021/12/20, check version at: https://github.com/puppeteer/puppeteer/releases
      BUILD_FLAVOR === DEBIAN11_BUILD_FLAVOR_MAP.FLAVOR_NODE_PUPPETEER13 && [ '13.0.0', 'PUPPETEER_VERSION.txt' ],
      // update at 2021/12/20, check version at: https://rubygems.org/pages/download
      BUILD_FLAVOR === DEBIAN11_BUILD_FLAVOR_MAP.FLAVOR_RUBY && [ '3.2.33', 'GEM_VERSION.txt' ]
